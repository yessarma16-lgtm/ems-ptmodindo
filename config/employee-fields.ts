...
export const EMPLOYEE_FIELDS: EmployeeField[] = [
  ...
  { key: "bpjsKtk", label: "BPJS KTK", type: "select", required: false, tabOrder: 49, section: "BPJS Information", spreadsheetColumn: "AW", optionsKey: "bpjsKtk" },
  { key: "bpjsKes", label: "BPJS KES", type: "select", required: false, tabOrder: 50, section: "BPJS Information", spreadsheetColumn: "AX", optionsKey: "bpjsKes" },
