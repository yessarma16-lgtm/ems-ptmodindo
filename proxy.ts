...
export const config = {
  matcher: [
    "/((?!login|apply|api/auth|api/apply|api/new-hiring/lookup|api/new-hiring/previous-jobs|api/cron|_next/static|_next/image|favicon.ico|logo-mod.jpg|icon.jpg|qr-section-bg.jpg).*)",
  ],
};
